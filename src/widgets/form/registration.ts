...
export default class RegistrationForm extends AbstractForm {
	...
	protected values: { firstName: string; lastName: string, email: string, password: string, birthDate: string, gender: string};
	...
	public init(): void {
		...
		this.rootElement.classList.add('form', 'form-registration');
